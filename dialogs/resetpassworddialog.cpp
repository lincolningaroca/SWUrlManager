...
void ResetPasswordDialog::setupConnections(){
  ...
  QObject::connect(ui->btnValidarUsuario, &QPushButton::clicked, this, &ResetPasswordDialog::onbtnValidarUsuario);
  QObject::connect(ui->btnRespuesta, &QAbstractButton::clicked, this, &ResetPasswordDialog::onbtnRespuesta);
  QObject::connect(ui->btnClaveNumerica, &QPushButton::clicked, this, &ResetPasswordDialog::onbtnClaveNumerica);
  QObject::connect(ui->btnAtras, &QPushButton::clicked, this, &ResetPasswordDialog::onbtnAtras);
  QObject::connect(ui->btnReset, &QPushButton::clicked, this, &ResetPasswordDialog::onbtnReset);

}

void ResetPasswordDialog::onbtnValidarUsuario(){
...
void ResetPasswordDialog::onbtnAtras(){
